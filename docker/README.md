...
official/supported Docker Images found at https://hub.docker.com/r/weicrypto/weid/
...
**NOTE: Please update the image description at https://hub.docker.com/r/weicrypto/weid-develop/ when changing the above text**