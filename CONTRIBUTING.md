Contributing to Wei Core
============================

The Wei Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/weicrypto/wei/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the Wei Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Wei
Network Protocol consensus changes.

Whether a pull request is merged into Wei Core rests with the project merge
...
Patches that change Wei consensus rules are considerably more involved than
...
Where a patch set proposes to change the Wei consensus, it must have been
...
The review process is normally fairly responsive on the Wei Core repository, however
...
The project leader is the release manager for each Wei Core release.
