#!/usr/bin/env python3
# Copyright (c) 2015-2020 The Wei Core developers
...
class LLMQDKGErrors(WeiTestFramework):
    def set_test_params(self):
        self.set_wei_test_params(4, 3, [["-whitelist=127.0.0.1"]] * 4, fast_dip3_enforcement=True)
