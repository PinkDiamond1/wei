...
class LLMQCoinbaseCommitmentsTest(WeiTestFramework):
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as WeiTestFramework doesn't support this atm)
