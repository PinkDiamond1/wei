...
//! Interface for the src/evo part of a wei node (weid process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a wei node (weid process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a wei node (weid process).
...
//! Top-level interface for a wei node (weid process).
class Node
{
public:
    virtual ~Node() {}
