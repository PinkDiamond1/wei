...
/** Utility functions used by the Wei Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "wei:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load wei specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a wei specific theme is activated (light/dark).*/
    bool weiThemeActive();
