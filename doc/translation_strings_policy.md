...
This document provides guidelines for internationalization of the Wei Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `wei_en.ts` remains unchanged.
