...
* wei.conf: contains configuration settings for weid or wei-qt
* weid.pid: stores the process id of weid while running
...
* debug.log: contains debug information and general logging generated by weid or wei-qt
