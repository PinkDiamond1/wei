...
This mechanism has been integrated into Bitcore-Node-Wei which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/weicrypto/insight-api#web-socket-api](https://github.com/weipay/insight-api-wei#web-socket-api)
* API: [https://github.com/weicrypto/insight-api#instantsend-transactions](https://github.com/weipay/insight-api-wei#instantsend-transactions)
